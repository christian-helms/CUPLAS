...
with open("bench/plas++_quality_over_size.json", "r") as f:
    plas_data_quality = json.load(f)

with open("bench/legacy_plas_quality_over_size.json", "r") as f:
    legacy_data_quality = json.load(f)

with open("bench/plas++_runtime_over_size.json", "r") as f:
    plas_data_runtime = json.load(f)

with open("bench/legacy_plas_runtime_over_size.json", "r") as f:
    legacy_data_runtime = json.load(f)

sizes = [item["H"] for item in plas_data_quality]

plas_quality = [item["score"] for item in plas_data_quality]
legacy_quality = [item["score"] for item in legacy_data_quality]

plas_runtime = [item["time"] for item in plas_data_runtime]
